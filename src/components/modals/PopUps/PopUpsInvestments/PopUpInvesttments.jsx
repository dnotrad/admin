            ...
            <div className={s.body}>
                <div className={s.header}>
                    <div className={s.title}>
                        <span className={s.title_main}></span>
                        <span className={s.sub_main}></span>
                    </div>
                ...
                <div className={s.check}>
                    <div className={s.garant}>
                        <span className={s.garant_subtitle}></span>
                        <span className={s.garant_info}>
                            <span className={s.id}></span>
                            =
                            <span className={s.invest}></span>
                ...
                <div className={s.input_value}>
                    <span className={s.input_value_title}></span>
