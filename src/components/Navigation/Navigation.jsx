...
function NavItem(props) {
    return (
        <NavLink to={`/${props.link}`} className={s.item_wrapper} activeClassName={s.active}>
            <div className={s.item_body}>
                <div className={s.item_row}>
                    <div className={s.item_icon}>
                        <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 2H3C2.175 2 1.5 2.675 1.5 3.5V15.5C1.5 16.325 2.175 17 3 17H15C15.825 17 16.5 16.325 16.5 15.5V3.5C16.5 2.675 15.825 2 15 2ZM14.25 15.5H3.75C3.3375 15.5 3 15.1625 3 14.75V4.25C3 3.8375 3.3375 3.5 3.75 3.5H14.25C14.6625 3.5 15 3.8375 15 4.25V14.75C15 15.1625 14.6625 15.5 14.25 15.5ZM12 5H9.75C8.925 5 8.25 5.675 8.25 6.5V8.21C7.8 8.4725 7.5 8.945 7.5 9.5C7.5 10.325 8.175 11 9 11C9.825 11 10.5 10.325 10.5 9.5C10.5 8.945 10.2 8.465 9.75 8.21V6.5H12V11.75C12 12.1625 11.6625 12.5 11.25 12.5H6.75C6.3375 12.5 6 12.1625 6 11.75V6.5H6.75C7.1625 6.5 7.5 6.1625 7.5 5.75C7.5 5.3375 7.1625 5 6.75 5H6C5.175 5 4.5 5.675 4.5 6.5V12.5C4.5 13.325 5.175 14 6 14H12C12.825 14 13.5 13.325 13.5 12.5V6.5C13.5 5.675 12.825 5 12 5Z" />
                        </svg>
                    </div>
                    <div className={s.item_name}>
                        {props.link}
                    </div>
                    <div className={`${s.item_to}`}>
...
export default function Navigation(props) {
    return (
        <div className={s.navigation_wrapper}>
            <div className={s.navigation_body}>
                <div className={s.navigation_column}>
                    <div className={s.attachment_wrapper}>
                        <div className={s.attachment_body}>
                            <span className={`${s.attachment} ${s.gray}`}></span>
                            <span className={`${s.attachment} ${s.purple}`}></span>
                            <span className={`${s.attachment} ${s.gray}`}></span>
                        </div>
                    </div>
                        ...
                        <div className={s.logo_body}>
                            <div className={s.logo_column}>
                                <div className={s.logo}>
                                    <img src={logo} alt="TRUMAN" />
                                </div>
                                <div className={s.title}>
                                    <span>Truman</span>
                                </div>
                                <div className={s.subtitle}>
                                    <span>Investments Holding</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className={s.nav_wrapper}>
                        ...
                        {<NavItem link={'Wallets'} />}
                        {<NavItem link={'Investments'} />}
                        {<NavItem link={'Portfolio'} />}
                        {<NavItem link={'Profit calculation'} />}
                        {<NavItem link={'Garant service'} />}
                        {<NavItem link={'Partners'} />}
                        {<NavItem link={'Settings'} />}
                        {<NavItem link={'Documents'} />}
                        {<NavItem link={'News'} />}
                    </div>
                    <div className={s.social_wrapper}>
                        <div className={s.social_body}>
                            <div className={s.social_row}>
                                <a className={`${s.social_icon} ${s.facebook}`}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 17.9895 4.3882 22.954 10.125 23.8542V15.4688H7.07812V12H10.125V9.35625C10.125 6.34875 11.9166 4.6875 14.6576 4.6875C15.9701 4.6875 17.3438 4.92188 17.3438 4.92188V7.875H15.8306C14.34 7.875 13.875 8.80008 13.875 9.75V12H17.2031L16.6711 15.4688H13.875V23.8542C19.6118 22.954 24 17.9895 24 12Z"  />
                                    </svg>
                                </a>
                                <a className={`${s.social_icon} ${s.twitter}`}>
                                ...
                                <a className={`${s.social_icon} ${s.instagram}`}>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
