...
const StyledRow = styled.div`
    ...
    grid-template-areas: "tb1 tb2 ${props=>props.mobile ? "tb2" : "tb3"} tb4";
    background: ${props => props.colour};
    padding: 16px;
`
...
function ProgressBar(props) {
    ...
    return (
        <div className={s.item_progress_wrapper}>
            <SemiCircleProgress endAngle={deg} radius={70} colourProgress={"url(#paint0_angular)"}>
...
function TableRowMobile(props) {
    return (
        <div className={s.row_wrapper}>
            <StyledRow mobile={true} colour={props.colour}>
                <div className={s.row_tb1}>
                    <StyledDot colour={props.data.up ? "var(--green)" : "var(--red)"} />
                    <span>{props.data.name}</span>
                </div>
                <div className={s.row_tb2}>
                    $ {Number(props.data.cap).toFixed(3)}
                    <div className={` ${props.data.up ? s.green : s.red}`}>
                        <img src={props.data.up ? up : down} alt="" />
                        <span>{props.data.up ? `+${props.data.profit}` : `-${props.data.profit}`}%</span>
                    </div>
                </div>
            ...
            <div className={s.body}>
                        ...
                        <div className={s.profit_wrapper}>
                            <div className={s.profit_body}>
                                ...
                                <div className={s.profit_info}>
                                    <div className={s.profit_info_slider}>
                                    ...
                                    <div className={s.profit_info_no_slider}>
                                        <ProfitItem img={invest} title={t("dashboard.invested")} money={data.invest} />
                                        <ProfitItem img={calendare} title={t("dashboard.montly")} money={data.profit} />
                                        <ProfitItem img={bank} title={t("dashboard.total")} money={data.all_income} />
                                    </div>
                ...
                <section className={s.statistics_wrapper}>
                    <div className={s.statistics_body}>
                        <div className={s.mobile_statistic}>
                            <div className={s.mobile_statistics_grid}>
                                <div className={s.statistic_select}>
                                    <div className={`${s.select_item} ${activeGraph === 0 && s.active_select}`} onClick={() => setActiveGraph(0)}>
                                        <span>{t("dashboard.profit_chart")}</span>
                                    </div>
                                    <div className={`${s.select_item} ${activeGraph === 1 && s.active_select}`} onClick={() => setActiveGraph(1)}>
                                        <span>{t("dashboard.investment_diagram")}</span>
                                    </div>
                                </div>
                                {activeGraph === 0 ? <div className={s.statistics_graph_row}>
                                    ...
                                    <div className={s.statistics_graph}>
                                        ...
                                        <ResponsiveContainer width="100%" height="100%" minHeight="300px" maxWidth="370px">
                                ...
                                </div> : <div className={s.mobile_statistics_divers_wrapper}>
                            ...
                            <div className={s.mobile_statistics_actives_wrapper}>
                                    ...
                                    <div className={s.statistics_actives_column}>
                                        ...
                                        <div className={s.statistics_actives_table}>
                                            <div className={s.statistics_actives_table_header}>
                                                ...
                                                <div className={s.row_tb2}>
                                                    <TableRowHeader title={t("dashboard.Capital") + "/" + t("dashboard.Daily_profit")} />
                                                </div>
                                                <div className={s.row_tb4}>
                                                    <TableRowHeader title={t("dashboard.Date")} />
                                                </div>
                                            </div>
                                            {data.actives[currentData].map((item, iter) => <TableRowMobile key={iter} data={item} colour={iter % 2 ? "var(--main-color)" : "var(--grey-main)"} />)}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className={s.no_mobile_statistic}>
