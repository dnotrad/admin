    ...
    <div className={s.tabel_wrap}>
      <div className={s.tabel}>
        ...
        <div className={s.texts}>
          ...
          <div className={s.text}>{props.text2}</div>
        </div>
      </div>
    </div>
  );
...
const Tabels = () => {
  return (
    <>
      ...
      <Tabel
        text="Обратите внимание, что после закрытия 5 статуса для получения бонусов за закрытие статусов Manger и Top Manager вам необходимо иметь в структуре не менее двух активных партнеров c указанными в таблице структурными оборотами, которые будут отображены как Левая и Правая ветка."
        text2="К Левой ветке относится структура активного партнера с меньшим оборотом, а к Правой с большим. По достижению статуса M1 открывается - 4 реферальная линия, бонус за доход от структуры равняется - 3% и максимальный бонус за закрытие статуса M5 - 5000 токенов."
      />
