  ...
  return (
    <div className={s.partners}>
      <div className={s.header}>
        <div className={s.nav}>
          <div
            className={`${s.nav_link} ${isInfo ? "" : s.active}`}
            onClick={() => setIsInfo(false)}
          >
            {t("partners.my_career")}
          </div>
          <div
            className={`${s.nav_link} ${isInfo ? s.active : ""}`}
        ...
        <div className={s.header_main}>
          {!isInfo ? (
            <div className={s.text}>{t("partners.content")}</div>
          ) : (
            <div className={s.text}>{t("partners.content2")}</div>
          )}
        </div>
      </div>
      {isInfo && (
            ...
            <div className={`${s.next_rang} ${s.referals_card}`}>
              <div className={s.circles_wrapper}>
                ...
                <div className={s.circles_info}>
                  ...
                  <div className={s.circles_number_info}>
                    {t("partners.Current_rank")}{" "}
                  </div>
                </div>
              </div>
              <div className={s.next_rang_info}>
                <div className={s.next_rang_title}>
                  {t("partners.Next_rank")} {propsEx.currentRang + 1}
                </div>
                ...
                <div className={s.next_rang_subtitle}>
                  ...
                  <span>
                    {t("partners.Rang")} {propsEx.currentRang + 1}
                  </span>
                </div>
              </div>
            </div>
